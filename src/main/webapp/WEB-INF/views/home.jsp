	...
	<div class="col-md-12 content-pad-0 box-icon-body">
		<sf:form id="docUploadForm" action="claim/uplodCpfDoc?${_csrf.parameterName}=${_csrf.token}" method="POST" enctype="multipart/form-data">  
			...
			<!-- <div class="col-md-6"> -->
				...
				<label class="col-sm-4 col-form-label" style="text-align: center;"><b>Upload KYC Document <span class="red">*</span></b><small class="form-text text-muted" style="text-align: center;">Upload "UAN" document would be preferable</small></label>
