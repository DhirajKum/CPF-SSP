	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active">
				<a class="nav-link text-white" style="padding-top: 0px; padding-bottom: 0px;" href="${pageContext.request.contextPath}/home">Home <span class="sr-only">(current)</span></a>
			</li>

			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle text-white" style="padding-top: 0px; padding-bottom: 0px;" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Manage </a>
			...
			<li class="nav-item dropdown" id="claimServ">
				...
				<a class="nav-link dropdown-toggle text-white" style="padding-top: 0px; padding-bottom: 0px;" href="#"	id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Claim Services </a>
				</security:authorize>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown"style="font-size: 12px">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle text-white" style="padding-top: 0px; padding-bottom: 0px;" href="#"	id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Role </a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown"style="font-size: 12px">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle text-white" style="padding-top: 0px; padding-bottom: 0px;" href="#"	id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> View </a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown"style="font-size: 12px">
