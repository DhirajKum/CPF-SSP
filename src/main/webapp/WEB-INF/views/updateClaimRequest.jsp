				...
				<div class="row marginT10">	
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-sm-7">
								<sf:input path="INSTALLMENT_NUMBER" cssclass="form-control  form-control-sm" id="installmentNo"  maxlength="3" onkeypress="return isNumber(event)" onblur="return range()"/>
							</div>
						</div>
					</div>
					<div class="col-md-6">
