			...
			<div class="col-md-12">
			  <sf:form action='${pageContext.request.contextPath}/claim/updateClaimRequest?reqType=${reqType}&claimReq=approve&reqId=${reqId}' method='POST' modelAttribute="actClaimDto" id="actClaimForm" onsubmit="this.js_enabled.value=1;return true;">
				...
				<div class="row marginT10">	
					...
					<div class="col-md-6">
						<div class="form-group row">
							<label for="lastDrawnAdvance" cssclass="col-sm-5 col-form-label" class="labelwidth"><b>Particular of Temporary advance last drawn, if  any</b></label>
							<div class="col-sm-7">
				...
				<div class="row">	
					...
					<div class="col-md-6">
						<div class="form-group row">
							<label for="casteDispute" cssclass="col-sm-5 col-form-label" class="labelwidth"><b>Caste Dispute <span class="red">*</span></b></label>
							<div class="col-sm-7">
				...
				<div class="row">	
					<div class="col-md-6">
						<div class="form-group row">
							<label for="amountSanc" cssclass="col-sm-5 col-form-label" class="labelwidth"><b>Amount Sanction <span class="red">*</span></b></label>
							<div class="col-sm-7">
...
$("#uploadOtherDoc").on('click', function(event) {
	...
	if (totalfiles > 0 && totalfiles < 6) {
		...
		if (fileCheck && totalfilesizeCheck) {
			$.ajax({
						type : 'POST',
						url : 'multiUplodCpfDoc?${_csrf.parameterName}=${_csrf.token}&reqId=${reqId}&claimSubmittedBy=${actClaimDto.CLAIM_SUBMITTED_BY}&fileType=2&claimAppliedFor='
								+ radioValue,
