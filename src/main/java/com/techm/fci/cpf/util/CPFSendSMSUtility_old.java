...
public class CPFSendSMSUtility_old
{
    public static void main(final String[] args) {
        ...
        try {
            ...
            final Connection con = DriverManager.getConnection("jdbc:oracle:thin:@10.248.225.74:1521:TEST1", "fcipayroll", "orclnov16");
            ...
            while (rs.next()) {
                ...
                if (ValidationMessage.equalsIgnoreCase("")) {
                    System.out.println("Inside DataValidation if");
                    ...
                    System.out.println("Url Created: " + httpsURL);
    ...
    static String DataValidation(final ResultSet rs) {
        ...
        try {
            ...
            Logger.getLogger(CPFSendSMSUtility_old.class.getName()).log(Level.SEVERE, null, ex);
        }
        return error_msg;
    }
}