...
public class RoleMappingBean {
	...
	public String getEmpParentZone() {
		return empParentZone;
	}
	public void setEmpParentZone(String empParentZone) {
		this.empParentZone = empParentZone;
	}
	...
	public String getPres_Loc_Code() {
		return pres_Loc_Code;
	}
	public void setPres_Loc_Code(String pres_Loc_Code) {
		this.pres_Loc_Code = pres_Loc_Code;
	}
